      ...
      <section id="contact">
        <div className="container" data-aos="fade-right">
          ...
          <div className="services-text">
            ...
            <h2>Contactez-moi</h2>
            <p className="mt-4">
              Vous préparez un évènement? <br /> Je suis à votre disposition
              pour toutes demandes de devis ou de renseignements complémentaires
              sur mes services. <br />
              Je serai ravie de vous aider à rendre votre évènement unique et
              mémorable!
            </p>
          </div>
        </div>
            ...
            <ul className="contact-list">
              ...
              <li>
                <Link target="_blank" href="mailto:serre.bopha@gmail.com">
                  ...
                  serre.bopha@gmail.com
                </Link>
              </li>
            </ul>
          </div>
          <div className="details-img">
            <Image src={naturelle} alt="jardin" className="img-fluid" />
          </div>
          <div className="social-network" data-aos="zoom-out">
            ...
            <ul className="contact-list">
              <li>
                <Link
                  target="_blank"
                  href="https://www.facebook.com/serre.bopha"
                >
                  <span className="icon">
                    <Image
                      src={facebook}
              ...
              <li>
                <Link
                  target="_blank"
                  href="https://www.instagram.com/bopha_serre/"
                >
                  <span className="icon">
                    <Image
                      src={instagram}
              ...
              <li>
                <Link
                  target="_blank"
                  href="https://www.linkedin.com/in/bopha-serre-3751351b/?originalSubdomain=fr"
                >
                  <span className="icon">
                    <Image
                      src={linkedin}
